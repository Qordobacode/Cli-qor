...
func (m *MockLocal) BuildDirectoryFilePath(j *types.File2Download, patterns []string, suffix string) string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BuildDirectoryFilePath", j, patterns, suffix)
	ret0, _ := ret[0].(string)
	return ret0
}
